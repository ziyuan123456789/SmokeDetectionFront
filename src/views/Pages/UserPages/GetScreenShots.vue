    ...
    <el-main>
      ...
      >
        <div class="button-wrapper">
          ...
          <el-button size="mini" class="wtf" type="success" @click="pushImage">收藏</el-button>
...
export default {
  ...
  methods: {
    ...
    deleteImage() {
      get('/images/deleteImage', {territoryId: this.data.territoryId,year: this.data.year ,day: this.data.day,name: this.currentImage.name }, true).then(res => {
    ...
    pushImage() {
      get('/images/likeImage', {name: this.currentImage.name }, true).then(res => {
        if (res.data.success === true) {
          ElMessage({
            message: '收藏成功',
            type: 'success'
